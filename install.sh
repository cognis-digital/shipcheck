#!/usr/bin/env sh
# Universal installer for shipcheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/shipcheck.git"
echo "Installing shipcheck ..."
