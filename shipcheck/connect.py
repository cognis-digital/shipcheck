"""Native cognis-connect emit for shipcheck — forward findings to any platform.

Maps shipcheck's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    shipcheck ... --format json | shipcheck-emit --to stix
    shipcheck-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
