"""SHIPCHECK core — Dockerfile linter with image-size and CVE advisories."""
...
RULES = [
    ("SHI-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SHI-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SHI-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
