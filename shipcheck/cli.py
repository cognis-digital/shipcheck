...
import argparse, sys
from shipcheck.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="shipcheck", description="SHIPCHECK — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from shipcheck.mcp_server import serve
        return serve()
    if args.cmd == "scan":
